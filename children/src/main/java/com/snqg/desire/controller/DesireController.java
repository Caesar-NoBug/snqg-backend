...
public class DesireController {
    ...
    public Response<AddDesireResponse> addDesire(
    ...
    public Response<AddThanksResponse> addThanks(
            @RequestParam String thanks,
            @RequestParam int id
    ){
    ...
    public Response<GetThanksResponse> getThanks(
            @RequestParam int id
            ){
        //String childId = UserHolder.getUserId();
    ...
    public Response<ModifyDesireResponse> modifyDesire(
            @RequestParam int id,
            @RequestParam String title,
        ...
        //修改数据库内容
        String message = desireService.modifyDesire(id,title,detail);
        //给一下提示信息
    ...
    public Response<ModifyThanksResponse> addThanks(
            @RequestParam int id,
            @RequestParam String thanks
    ){
        //修改数据库内容
    ...
    public Response<RemoveDesireResponse> removeDesire(
            @RequestParam int id
    ){
    ...
    public Response<RemoveThanksResponse> removeThanks(
            @RequestParam int id
    ){
